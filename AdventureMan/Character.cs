        ...
        public bool EquipUseBehavior(int slotUsed) 
        {
            ...
            if (charInventory[slotUsed].ToUpper() == ItemAttributeList.breastplateName) // Breastplate
            {
                if (charEquipmentLoadOut[Convert.ToInt32(ItemAttributeList.breastplateArmorSlot[0])].ToUpper() == "EMPTY")
                {
                    ...
                    charEquipmentLoadOut[Convert.ToInt32(ItemAttributeList.breastplateArmorSlot[0])] = charInventory[slotUsed];
                    ...
                    Console.WriteLine($"You have equipped the {charInventory[slotUsed]} to your {ItemAttributeList.breastplateArmorSlot[1]}.");
                ...
                else 
                {
                    ...
                    Console.WriteLine($"Could not equip {charInventory[slotUsed]} since that equipment slot is taken by {charEquipmentLoadOut[Convert.ToInt32(ItemAttributeList.breastplateArmorSlot[0])]}");
            ...
            else if (charInventory[slotUsed].ToUpper() == ItemAttributeList.steelBootsName) // Steel Boots
            {
                if (charEquipmentLoadOut[Convert.ToInt32(ItemAttributeList.steelBootsArmorSlot[0])].ToUpper() == "EMPTY")
                {
                    ...
                    charEquipmentLoadOut[Convert.ToInt32(ItemAttributeList.steelBootsArmorSlot[0])] = charInventory[slotUsed];
                    ...
                    Console.WriteLine($"You have equipped the {charInventory[slotUsed]} to your {ItemAttributeList.steelBootsArmorSlot[1]}.");
                ...
                else
                {
                    ...
                    Console.WriteLine($"Could not equip {charInventory[slotUsed]} since that equipment slot is taken by {charEquipmentLoadOut[Convert.ToInt32(ItemAttributeList.steelBootsArmorSlot[0])]}");
            ...
            else if (charInventory[slotUsed].ToUpper() == ItemAttributeList.longswordName) // Longsword
            {
                ...
                {
                    if (ItemAttributeList.longswordCanBeOneHanded == true && ItemAttributeList.longswordCanBeTwoHanded == true)
                    {
                    ...
                    else if (ItemAttributeList.longswordCanBeOneHanded == false && ItemAttributeList.longswordCanBeTwoHanded == true)
                    {
                        if (charEquipmentLoadOut[1].ToUpper() == "EMPTY")
                        {
                            wasItemEquipped = true;
